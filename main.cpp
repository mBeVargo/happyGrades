...
//load data from file
    ...
    while(getline(fileStream, input)) {
        ...
        //add file data to be stored in a map
...
//after " of department, set a true to get the score after a space until another space
    ...
    */
    ...
    //store specific search items in vectors to faster times and ease of use. Furthermore, allows the user to add functions easily
...
//takes what user inputted and finds data. If data does not exist or user miss typed, prints out error message
...
if (searchFound == true) {
    ...
    //prints out the data based upon what was searched.
